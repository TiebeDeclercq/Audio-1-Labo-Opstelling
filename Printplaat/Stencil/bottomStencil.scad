// Generated by SolidPython 1.1.3 on 2025-11-13 14:27:48
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
		scale(v = [1, 1, 1]) {
			difference() {
				linear_extrude(height = 1.5000000000) {
					offset(r = 5.1000000000) {
						import(file = "C:/Users/tiebe/Desktop/Electronics/School/Patje zuig men kloten/Audio + Vermogen Opstelling/Stencil/Audio + Vermogen Opstelling-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.8000000000) {
			offset(chamfer = false, delta = 0.1000000000) {
				import(file = "C:/Users/tiebe/Desktop/Electronics/School/Patje zuig men kloten/Audio + Vermogen Opstelling/Stencil/Audio + Vermogen Opstelling-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
